...
export const examples: Registry["items"] = [
  {
    ...
    registryDependencies: ["@gk/apple-hello-effect"],
    files: [
      {
  ...
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@gk/theme-switcher"],
    files: [
      {
  ...
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@gk/wheel-picker"],
    files: [
      {
  ...
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@gk/wheel-picker", "form"],
    files: [
      {
  ...
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@gk/work-experience"],
    files: [
      {
  ...
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@gk/slide-to-unlock", "@gk/use-sound"],
    files: [
      {
  ...
  },
  {
    ...
    type: "registry:example",
    registryDependencies: ["@gk/slide-to-unlock"],
    files: [
      {

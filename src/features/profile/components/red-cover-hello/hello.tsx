...
const layers = ["xin-chao", "your-wordmark"] as const; // Replace "your-wordmark" with your brand identifier
    ...
    <>
      <AnimatePresence mode="wait" initial={false}>
        ...
        >
          ...
          {layers[currentIndex] === "your-wordmark" && ( // Replace "your-wordmark" with your brand identifier
            <motion.div

...
export const Icons = {
  ...
  meta: (props: IconProps) => <SiMeta {...props} />,
  ...
  shadcn: (props: IconProps) => <SiShadcnui {...props} />,
  v0: (props: IconProps) => (
...
// PNG icon mapping for tech stack
const pngIconMap: Record<string, string> = {
  // Core languages/frameworks from tech-stack
  python: "Python",
  ts: "ts",
  js: "js",
  cpp: "C++ (CPlusPlus)",
  ...
  numpy: "NumPy",
  pytorch: "PyTorch",
  "langchain-color": "langchain-color",
  "langgraph-color": "langgraph-color",
  "langsmith-color": "langsmith-color",
  "bedrock-color": "bedrock-color",
  ollama: "ollama",
